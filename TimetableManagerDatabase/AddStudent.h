...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(92, 25);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(192, 36);
			...
			this->label2->Location = System::Drawing::Point(48, 107);
			...
			this->textBox1->Location = System::Drawing::Point(52, 130);
			...
			this->textBox2->Location = System::Drawing::Point(52, 189);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(140, 245);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		try
		{
			...
			cmd->CommandText = "INSERT INTO dbo.Students (student_id, student_name) VALUES (@id, @name)";
			cmd->Parameters->AddWithValue("@id", textBox1->Text);
			cmd->Parameters->AddWithValue("@name", textBox2->Text);
			cmd->ExecuteNonQuery();
			connection->Close();
			MessageBox::Show("Student Added Successfully!","Notice",MessageBoxButtons::OK,MessageBoxIcon::Asterisk);
			this->Close();
		}
		catch (Exception^ exc)
		{
