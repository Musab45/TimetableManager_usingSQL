...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Click += gcnew System::EventHandler(this, &AddTeacher::label3_Click);
			// 
			// textBox1
			// 
			...
			this->label1->Size = System::Drawing::Size(197, 36);
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) 
{
	...
	try
	{
		...
		cmd->CommandText = "INSERT INTO dbo.Teachers (teacher_id, teacher_name) VALUES (@id, @name)";
		cmd->Parameters->AddWithValue("@id", textBox1->Text);
		cmd->Parameters->AddWithValue("@name", textBox2->Text);
		cmd->ExecuteNonQuery();
		connection->Close();
		MessageBox::Show("Teacher Added Successfully!", "Notice", MessageBoxButtons::OK, MessageBoxIcon::Asterisk);
		this->Close();
	}
	catch (Exception^ exc)
	{
